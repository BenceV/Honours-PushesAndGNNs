...
def make_mlp_model_alt():
  ...
  return snt.Sequential([
      snt.nets.MLP([latent_size] * number_of_layers, activate_final=True),
      snt.LayerNorm()
  ])
...
class MLPGraphIndependent(snt.AbstractModule):
  ...
  def __init__(self, number_of_layers, latent_size, name="MLPGraphIndependent"):
    ...
    #print("Independent Block Init: " + str(number_of_layers) + " " + str(latent_size))
...
class MLPGraphNetwork(snt.AbstractModule):
  ...
  def __init__(self, number_of_layers, latent_size, name="MLPGraphNetwork"):
    ...
    #print("Full Block Init: " + str(number_of_layers) + " " + str(latent_size))
    with self._enter_variable_scope():
